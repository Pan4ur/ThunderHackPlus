...
public class TSubBindButt extends TItem{
    ...
    public TSubBindButt(Setting setting, int x, int y) {  //127 40   //84  27
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawRect2(this.x,this.y,this.x + 94,this.y + 23, ThunderHackGui.getInstance().buttsColor.getValue().getColorObject().getRGB());

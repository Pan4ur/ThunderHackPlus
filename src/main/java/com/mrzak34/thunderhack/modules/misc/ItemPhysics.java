...
public class ItemPhysics extends Module {
    ...
    private static final Random Field1900 = new Random();
    ...
    public void Method2279(Entity entity, double d, double d2, double d3) {
        ...
        int n = (itemStack = (entityItem = (EntityItem) entity).getItem()) != null && itemStack.getItem() != null ? Item.getIdFromItem(itemStack.getItem()) + itemStack.getMetadata() : 187;
        Field1900.setSeed(n);

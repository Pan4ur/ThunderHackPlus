...
public class RenderSchematic extends RenderGlobal {
    ...
    @Override
    public Vector3f getViewVector(final Entity entity, final double partialTicks) {
    ...
    public void renderBlockLayer(final BlockRenderLayer layer) {
        this.mc.entityRenderer.enableLightmap();
    ...
    public void markBlocksForUpdate(final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final boolean needsUpdate) {
        if (this.world == null) {
            return;
        }
